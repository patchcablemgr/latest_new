...
define('REGISTER_LINK', '<a href="#" onclick="window.history.back()">register</a>');
...
define('ADMIN_LINK', '<a href="#">ADMIN_LINK</a>');
...
define('MFA_LABEL', 'Google Auth Code');
...
// Custom errors
define('CUSTOM_SQL_INSTANTIATE_DB_ERROR', 'Bad database info provided.');
define('CUSTOM_APP_DB_PREFIX', 'app_');
